...
void main() {
	...
	vec4 rocky = (smoothstep(0.30, 0.50, vAmount) - smoothstep(0.35, 0.80, vAmount)) * texture2D( rock, vUV * 20.0 );
	vec4 snowy = (smoothstep(0.50, 0.75, vAmount))                                   * texture2D( snow, vUV * 10.0 );
